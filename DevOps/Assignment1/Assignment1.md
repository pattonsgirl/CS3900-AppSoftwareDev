...
*Hint: See the [Docker CLI documentation](https://docs.docker.com/reference/cli/docker/](https://docs.docker.com/reference/cli/docker/container/run/#env) on how to use a file for environment variables.*
